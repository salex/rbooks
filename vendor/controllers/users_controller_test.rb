...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user" do
    assert_difference('User.count') do
      post users_url, params: { user: { default_book: @user.default_book, email: @user.email, full_name: @user.full_name, password: 'secret', password_confirmation: 'secret', roles: @user.roles, username: @user.username } }
    end
